...
(cffi:defcfun ("_wrap_BRepAlgoAPI_Algo_GetReport" _wrap_BRepAlgoAPI_Algo_GetReport) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_BRepAlgoAPI_Algo_HasErrors" _wrap_BRepAlgoAPI_Algo_HasErrors) :bool
  (self :pointer))

(cffi:defcfun ("_wrap_BRepAlgoAPI_Algo_HasWarnings" _wrap_BRepAlgoAPI_Algo_HasWarnings) :bool
  (self :pointer))
...
(cffi:defcfun ("_wrap_new_BRepAlgoAPI_Fuse__SWIG_2" _wrap_new_BRepAlgoAPI_Fuse__SWIG_2) :pointer
  (S1 :pointer)
  (S2 :pointer))
